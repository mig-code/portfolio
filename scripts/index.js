...
const projects = [
  {
    ...
    whyText:
      "In fermentum leo sit amet urna sollicitudin, in malesuada tellus laoreet. Quisque enim ex, luctus ut interdum at, iaculis vitae libero. Nam sed mi elit. Maecenas euismod tristique nisi vitae cursus. Aenean a ante scelerisque, blandit magna mollis, interdum nisi. Quisque eget lacinia nisi, eget molestie ex. Mauris tincidunt dui quam, a dictum lacus cursus at. Mauris fringilla ante sed fringilla feugiat. Curabitur ac arcu pellentesque, interdum ex in, porttitor velit. Donec eget sollicitudin erat. Aliquam in arcu tortor. Donec vitae luctus massa. Suspendisse ut condimentum nisl. Phasellus at sollicitudin erat.",
    howText:
      "In fermentum leo sit amet urna sollicitudin, in malesuada tellus laoreet. Quisque enim ex, luctus ut interdum at, iaculis vitae libero. Nam sed mi elit. Maecenas euismod tristique nisi vitae cursus. Aenean a ante scelerisque, blandit magna mollis, interdum nisi. Quisque eget lacinia nisi, eget molestie ex. Mauris tincidunt dui quam, a dictum lacus cursus at. Mauris fringilla ante sed fringilla feugiat. Curabitur ac arcu pellentesque, interdum ex in, porttitor velit. Donec eget sollicitudin erat. Aliquam in arcu tortor. Donec vitae luctus massa. Suspendisse ut condimentum nisl. Phasellus at sollicitudin erat.",
...
accordionTitle.forEach((eachTitle, i) => {
  ...
  accordionTitle[i].addEventListener("click", () => {
    accordionTitle[i].classList.toggle("accordion_title--active");
